...
/// API for listing favourited statuses.
class FavouritesApi {
  /// Creates a [FavouritesApi] instance with the given [MastodonHttpClient].
  const FavouritesApi(this._http);

  final MastodonHttpClient _http;

  /// Fetches the authenticated user's favourited statuses.
  ///
