...
@override
String toString() {
  return 'MastodonTag(id: $id, name: $name, url: $url, history: $history, following: $following, featuring: $featuring)';
}
...
@override
String toString() {
  return 'MastodonTagHistory(day: $day, uses: $uses, accounts: $accounts)';
}
