...
part 'mastodon_search_result.freezed.dart';
...
class MastodonSearchResult with _$MastodonSearchResult {
...
@Freezed(toStringOverride: false)
@JsonSerializable(fieldRename: FieldRename.snake)
class MastodonSearchResultV1 with _$MastodonSearchResultV1 {
  // ignore: remove_deprecations_in_breaking_versions
  @Deprecated(
